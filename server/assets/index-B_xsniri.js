import { r as reactExports, T as jsxRuntimeExports } from "./worker-entry-CSKn-ep5.js";
import "node:events";
...
function Navbar() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "glass flex w-full max-w-3xl items-center justify-between rounded-full px-4 py-2.5 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#top", className: "flex items-center gap-2 text-sm font-medium tracking-tight", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-gradient-to-br from-[var(--neon)] to-[var(--violet)]", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "h-3.5 w-3.5 text-background" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "dev.portfolio" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex items-center gap-1 text-sm text-muted-foreground", children: links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: l.href,
...
function normaliseOffset(offset) {
  if (offset.length !== 2)
    return void 0;
  const result = [];
  for (const item2 of offset) {
    if (Array.isArray(item2)) {
      result.push(item2);
    } else if (typeof item2 === "string") {
      const parsed = parseStringOffset(item2);
      if (!parsed)
        return void 0;
      result.push(parsed);
    } else {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.p,
                {
                  ...
                  children: "Transformando complexidade em elegância digital. Performance, cuidado e propósito em cada linha de código."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.p,
                {
                  ...
                  children: "Design com propósito e código limpo."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "#projects", className: "btn-primary group", children: [
                      "Ver projetos",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "#contact", className: "btn-ghost", children: "Entrar em contato" })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                motion.div,
                {
                  ...
                  children: [
                    ...
                    { k: "ADS", v: "Em formação" }
                  ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background/60 px-4 py-5 text-center backdrop-blur", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-xl font-medium text-white", children: s.k }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-xs text-white/70", children: s.v })
                  ] }, s.v))
                }
              )
            ]
...
function Reveal({ children, delay: delay2 = 0, y = 24, ...rest }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    motion.div,
    {
      ...
      transition: { duration: 0.7, delay: delay2, ease: [0.2, 0.8, 0.2, 1] },
      ...rest,
      children
    }
  );
...
function AboutMe() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "relative py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-6xl px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-12 md:grid-cols-2 md:items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest text-[var(--neon)]", children: "03 — Sobre Mim" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-balance text-4xl font-medium tracking-tight sm:text-5xl", children: [
        "Design com propósito e",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif italic text-muted-foreground", children: "código limpo" }),
        "."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-base leading-relaxed text-muted-foreground", children: "Estou em transição de carreira para a área de tecnologia, mais especificamente para o desenvolvimento de software. Antes disso, não tinha contato direto com a área, mas comecei a estudar programação e fui me interessando cada vez mais por como os sistemas funcionam e como é possível criar soluções usando texto." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-relaxed text-muted-foreground", children: "Essa mudança não foi imediata. Estou passando por um processo de aprendizado, começando do básico e construindo uma base sólida em lógica de programação, desenvolvimento web e outras tecnologias. Sei que é uma área que exige dedicação e prática constante, então tenho me esforçado para evoluir aos poucos." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 text-base leading-relaxed text-muted-foreground", children: "Hoje meu foco é ganhar experiência prática, seja com projetos pessoais ou oportunidades de estágio, para conseguir me desenvolver na área e me inserir no mercado de tecnologia. Estou tratando essa transição como um processo sério de construção de carreira, com paciência e consistência." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: 0.2, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex justify-center md:justify-end", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-64 w-64 overflow-hidden rounded-2xl glass p-2 sm:h-80 sm:w-80", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: "./img/perfil.jpg",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-xl bg-gradient-to-t from-black/20 to-transparent pointer-events-none" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function SpotlightCard({ children, className = "" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, onMouseMove: onMove, className: `spotlight ${className}`, children });
}
const projects = [
  {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "relative py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        className: "mb-16",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest text-[var(--neon)]", children: "01 — Trabalhos selecionados" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-balance text-4xl font-medium tracking-tight sm:text-5xl", children: [
            "Projetos com foco em",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif italic text-muted-foreground", children: "detalhe" }),
            "."
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: projects.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(motion.div, { variants: item$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SpotlightCard, { className: "hover-lift glass group h-full overflow-hidden rounded-2xl p-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-video w-full overflow-hidden border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: p.image,
              alt: p.title,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-8", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-[11px] uppercase tracking-wider text-muted-foreground", children: p.tag }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 text-2xl font-medium tracking-tight", children: p.title })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-muted-foreground", children: p.year })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-4 max-w-md text-sm leading-relaxed text-muted-foreground", children: p.desc }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "flex flex-wrap gap-1.5", children: p.stack.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "li",
                {
              ...
              p.link && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-4 w-4 transition-transform group-hover:rotate-12" })
                }
              )
            ] })
          ] })
...
function Stack() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "stack", className: "relative py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-6xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        initial: { opacity: 0, y: 20 },
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest text-[var(--violet)]", children: "02 — Tech stack" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-balance text-4xl font-medium tracking-tight sm:text-5xl", children: [
            "Ferramentas que uso",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif italic text-muted-foreground", children: "todos os dias" }),
            "."
          ] })
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: stack.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.span,
          {
            variants: item,
...
function Timeline() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "trajectory", className: "relative py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest text-[var(--neon)]", children: "03 — Trajetória" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-3 text-balance text-4xl font-medium tracking-tight sm:text-5xl", children: [
        "Uma linha do tempo de",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif italic text-muted-foreground", children: "curiosidade" }),
        "."
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "relative border-l border-border pl-8", children: items.map((it, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { delay: i * 0.08, y: 16, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "relative pb-12 last:pb-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "absolute -left-[37px] top-1.5 flex h-3 w-3 items-center justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute h-3 w-3 animate-ping rounded-full bg-[var(--neon)]/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "relative h-2 w-2 rounded-full bg-[var(--neon)]" })
      ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-2 text-xl font-medium tracking-tight", children: it.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 max-w-xl text-sm leading-relaxed text-muted-foreground", children: it.desc })
    ] }) }, it.title)) })
  ] }) });
}
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "relative py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-4xl px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Reveal, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass relative overflow-hidden rounded-3xl p-10 text-center sm:p-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          "aria-hidden": true,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono text-xs uppercase tracking-widest text-[var(--violet)]", children: "04 — Vamos conversar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "mt-4 text-balance text-4xl font-medium tracking-tight sm:text-5xl", children: [
        "Tem uma ideia em mente?",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif italic text-gradient-accent", children: "Construímos juntos." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mx-auto mt-5 max-w-lg text-sm leading-relaxed text-muted-foreground", children: "Aberto a freelances, colaborações e oportunidades full-time. Respondo em até 24h." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: "mailto:wesleytenorio526@gmail.com", className: "btn-primary group mt-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-4 w-4" }),
        "wesleytenorio526@gmail.com",
        /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowUpRight, { className: "h-4 w-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-10 flex items-center justify-center gap-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-16 flex flex-col items-center justify-between gap-3 border-t border-border pt-8 text-xs text-muted-foreground sm:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-mono", children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Wesley Tenorio"
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-mono", children: "Desenvolvido com Foco em Performance e Elegância" })
    ] })
  ] }) });
}
function Meteors() {
  ...
  reactExports.useEffect(() => {
    ...
    const spawn = () => {
      const angle = Math.PI / 180 * (200 + Math.random() * 25);
      meteors.push({
    ...
    const tick = (t) => {
      ...
      for (let i = meteors.length - 1; i >= 0; i--) {
        ...
        const fade = m.life < 12 ? m.life / 12 : m.life > m.maxLife - 20 ? Math.max(0, (m.maxLife - m.life) / 20) : 1;
...
function MeteorLayer() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Meteors, {})
    }
  );
}
function ParticleField() {
  ...
  reactExports.useEffect(() => {
    ...
    const resize2 = () => {
      ...
      canvas.height = height * dpr;
      ctx.setTransform(dpr, 0, 0, dpr, 0, 0);
      const count = Math.min(90, Math.floor(width * height / 18e3));
    ...
    const tick = () => {
      ...
      for (let i = 0; i < particles.length; i++) {
        for (let j = i + 1; j < particles.length; j++) {
          ...
          if (d2 < 12e3) {
            const alpha2 = 1 - d2 / 12e3;
            ctx.strokeStyle = `rgba(140, 170, 255, ${alpha2 * 0.18})`;
            ctx.lineWidth = 0.6;
            ctx.beginPath();
            ctx.moveTo(a.x, a.y);
            ctx.lineTo(b.x, b.y);
...
function Index() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "relative min-h-screen overflow-x-hidden", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AboutMe, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pointer-events-none fixed inset-0 -z-20 h-full w-full opacity-40", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleField, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MeteorLayer, {}),
