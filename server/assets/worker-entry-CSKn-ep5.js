...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-ClIYSRQA.js");
...
var ROUTER_BASEPATH = "port-definitivo";
var SERVER_FN_BASE = "/port-definitivo/_serverFn/";
