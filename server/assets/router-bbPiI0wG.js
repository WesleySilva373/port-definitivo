...
const appCss = "/port-definitivo/assets/styles-Qh0mPUWu.css";
...
const Route$1 = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Portfólio de desenvolvedor Full Stack — minimalismo, performance e engenharia." },
      { name: "author", content: "Portfolio" },
      { property: "og:title", content: "Full Stack Developer · Portfolio" },
      { property: "og:description", content: "Projetos, stack e trajetória." },
...
const $$splitComponentImporter = () => import("./index-B_xsniri.js");
const Route2 = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfólio de Wesley Tenorio — Transformando complexidade em elegância digital."
    }, {
      property: "og:title",
      content: "Wesley Tenorio · Portfolio"
    }, {
